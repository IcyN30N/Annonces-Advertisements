...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { advertiser_id: @advertisement.advertiser_id, content: @advertisement.content, price: @advertisement.price, published: @advertisement.published, title: @advertisement.title } }
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { advertiser_id: @advertisement.advertiser_id, content: @advertisement.content, price: @advertisement.price, published: @advertisement.published, title: @advertisement.title } }
